...
const generateAIReview = async() =>{
  ...
  try {
    ...
    2~3문단 분량의 상세하고 흡입력있는 추천평을 작성해줘 (이모지 필수)
...
.synopsis-text { font-size: 17px; line-height: 1.9; color: #dcded1; text-align: justify; margin: 0; }
